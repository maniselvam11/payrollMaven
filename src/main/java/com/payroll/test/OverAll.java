	...
	public static void main(String[] args) {
		...
		case 1:
			do {
				...
				Admin currentUser = new Admin(emailId, password);
				flag = userDao.validateAdmin(currentUser);
			...
			case 1:
				...
				do {
					...
					case 1:
						...
						Departments dprt = departmentDao.findDepartment(deptID);
						...
						boolean empInsert = employeeDaoImpl.insertEmp(emp);
					...
					case 2:
						...
						EmployeeDaoImpl empUpdateDao = new EmployeeDaoImpl();
					...
					case 3:
						...
						EmployeeDaoImpl empDeleteDao = new EmployeeDaoImpl();
...
//						int depID = Integer.parseInt(sc.nextLine());
						EmployeeDaoImpl empShowDao = new EmployeeDaoImpl();
						List<Employee> empShow = empShowDao.showEmployee();
...
//				case 2:
					...
					case 1:
						...
						DepartmentsDaoImpl updDept = new DepartmentsDaoImpl();
						updDept.updateDept(updId, updDeptName);
						break;

					case 2:
						System.out.println("Show all departments");
						DepartmentsDaoImpl showDept = new DepartmentsDaoImpl();
			...
			case 3:
				do {
					...
					case 2:
						...
						GradeDaoImpl delGradeDao = new GradeDaoImpl();
					...
					case 3:
						...
						GradeDaoImpl grdUpd = new GradeDaoImpl();
					...
					case 4:
						...
						GradeDaoImpl showGrd = new GradeDaoImpl();
			...
			case 4:
				...
				do {
					...
					case 1:
						...
						Employee employe = employDao.findEmployee(emploID);
						Leave leave = new Leave(employe, leaveDt, leaveReason);
						LeaveDaoImpl leaveDaoImpl = new LeaveDaoImpl();
						boolean leaveResult = leaveDaoImpl.insertLeave(leave);
					...
					case 2:
						...
						LeaveDaoImpl showLeave = new LeaveDaoImpl();
				...
				do {
					...
					case 1:
						...
						while (!empSalaryemail.matches("[a-z][a-z0-9]+[@][a-z]+[.][a-z]+") || empSalaryemail.isEmpty())
							;
						EmployeeDaoImpl employeeDaoImpl = new EmployeeDaoImpl();
						Employee employee = employeeDaoImpl.findEmploy(empSalaryemail);
						...
						Grade grde = gradeDaoImpl.findGrade(gradeName);
						String deptName = null;
						do {
						...
						Departments dpart = departmentsDaoImpl.findDepartment(deptName);
						...
						try {
							...
							int empId = employDao.findEmployeeID(employee);
							leave = leaveDaoImpl.findLeave(leaveDt, empId);
						...
						GradeDaoImpl gradesDao = new GradeDaoImpl();
						EmployeeDaoImpl employeDao = new EmployeeDaoImpl();
						LeaveDaoImpl leaveDaoImpl = new LeaveDaoImpl();

						long grossSalary = gradesDao.grossSalary(gradeName);
						System.out.println("GrossSalary " + grossSalary);
						int employID = employeDao.findEmployeeID(employee);
						System.out.println("EmployeeID " + employID);
						int noOfLeave = leaveDaoImpl.leaveDays(employID);
						System.out.println("count Leave Days " + noOfLeave);
						long perDaySalary = gradesDao.perDaySalary(gradeName);
						System.out.println("PerDay Salary " + perDaySalary);
						long basicSalary = gradesDao.basicSalary(gradeName);
						System.out.println("Basic Salary " + basicSalary);
						long bonus = gradesDao.bonus(gradeName);
						long pt = gradesDao.professionalTax(gradeName);
						long pf = gradesDao.providentFund(gradeName);
						...
						if (pfChoise == 'y') {
							...
							if (bonusChoise == 'y') {
								...
								salaryCal.insertSalary(employee, grde, dpart, leave, salaryDt, grossSalary, salary);
							} else {
								long salaryBonus = (((basicSalary + bonus + pt) - (noOfLeave * perDaySalary)) - pf);
								System.out.println("Employee salary" + salaryBonus);
								SalaryCalculateDaoImpl salaryCal = new SalaryCalculateDaoImpl();

								salaryCal.insertSalary(employee, grde, dpart, leave, salaryDt, grossSalary,
										salaryBonus);
...
//							SalaryCalculateDao salaryCal=new SalaryCalculateDao();
								...
								boolean result = salaryCal.insertSalary(employee, grde, dpart, leave, salaryDt,
										grossSalary, salary);
								if (result != false) {
